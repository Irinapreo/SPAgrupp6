...
const ArticleList = () => {
  ...
  const handleDecline = () => {
    setShowOverlay(true); // Show the overlay when "Decline" is clicked
  };

  const handleOverlayClick = () => {
    setShowOverlay(false); // Hide the overlay when it is clicked
  };
  ...
  return (
    <div className="container">
      ...
      <div className="row mt-4">
        <div className="col-md-12">
          <h4 className="article-count">
            Antal artiklar: {filteredArticles.length}
          </h4>
        </div>
      </div>
              ...
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title">
                    {highlightText(article.Title, searchString)}
                  </h5>
                  <p className="card-text">
                    {highlightText(article.Summary, searchString)}
                  </p>
                  <a
                    href={article.Link}
                    className="card-link"
